...
\lstset{ 
	language		= C,
	captionpos		= b, % posición de pie de código, b=debajo, t=top
	basicstyle		= \ttfamily, % estilo de letra general
	columns			= fixed, % columnas alineadas
	keywordstyle	= \color{blue},
	breaklines		= true, % se permiten las lineas que que exceden del ancho del documento
	keywordstyle	= \color{blue},%
...
\lstinputlisting[language=C,caption=Ej 3,label=fig:ej3]{scripts/main.c} %una forma de agregar archivos fuente
